...
function DataStore:GetData(dataFile,optFile)
	if Services['RunService']:IsClient() then
		repeat wait() until DataStore['Initialized'] and DataStore['Cached'] and DataStore.LoadedPlayers == true
	...
	elseif Services['RunService']:IsServer() then
		repeat wait() until DataStore.LoadedPlayers[dataFile] ~= nil and DataStore.Cache[dataFile] ~= nil
